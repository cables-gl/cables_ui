...
CABLES.UI.KeyManager = class extends CABLES.EventTarget
{
    ...
    _onKeyDown(e)
    {
        ...
        for (let i = 0; i < this._keys.length; i++)
        {
            ...
            if (k.options.hasOwnProperty("ignoreInput") && k.options.ignoreInput && document.activeElement && (document.activeElement.tagName == "INPUT" || document.activeElement.tagName == "TEXTAREA")) continue;
