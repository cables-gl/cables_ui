...
export default class CanvasLens
{
    ...
    _onMouseMove(e)
    {
        ...
        this._x = (e.clientX - rect.left) / gui.corePatch().cgl.canvasScale; // x position within the element.
        this._y = (e.clientY - rect.top) / gui.corePatch().cgl.canvasScale; // y position within the element.
