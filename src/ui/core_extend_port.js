...
{
    /** @type {(...args: any[]) => any} stashed original _onTriggered while step-debugging/profiling is active */
    _oldTriggered;

    /** @type {(...args: any[]) => any} stashed original trigger while step-debugging is active */
    _oldTrigger;

    /** @type {(...args: any[]) => any} stashed original set while step-debugging/profiling is active */
    _oldSet;
