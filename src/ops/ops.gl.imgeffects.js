...
.endl()+'{'
.endl()+'    // The parameters are hardcoded for now, but could be'
.endl()+'    // made into uniforms to control fromt he program.'
.endl()+''
.endl()+'    vec2 invtexsize=vec2(1.0/1024.0,1.0/1024.0);'
.endl()+''
.endl()+'    float FXAA_SPAN_MAX = 8.0;'
.endl()+'    float FXAA_REDUCE_MUL = 1.0/8.0;'
.endl()+'    float FXAA_REDUCE_MIN = (1.0/128.0);'
.endl()+''
.endl()+'    float step=1.0;'
.endl()+''
