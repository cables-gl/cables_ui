...
illegal:"\\S"}}})();hljs.registerLanguage("json",e)})();/*! `go` grammar compiled for Highlight.js 11.6.0 */
...
},a.FUNCTION_DISPATCH]}}})();hljs.registerLanguage("scss",e)})();/*! `ruby` grammar compiled for Highlight.js 11.6.0 */
(()=>{var e=(()=>{"use strict";return e=>{
...
aliases:["yml"],contains:b}}})();hljs.registerLanguage("yaml",e)})();/*! `glsl` grammar compiled for Highlight.js 11.6.0 */
...
className:"meta",begin:"#",end:"$"}]})})();hljs.registerLanguage("glsl",e)})();/*! `diff` grammar compiled for Highlight.js 11.6.0 */
